  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.2fr,0.8fr]">
        ...
        <CharacterDisplay state={resolveCharacterState(systemState)} title="Mini Companion" subtitle="Hovering in the corner and reacting to the cluster." />
      </div>
      <Card>
        <p className="text-xs uppercase tracking-[0.2em] text-zinc-500">Recent Activity</p>
